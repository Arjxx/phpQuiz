...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $quizName = $_POST['quiz_name']; // Get the common quiz name here
    ...
    for ($i = 1; $i <= 3; $i++) {
        ...
        $stmt = $conn->prepare("INSERT INTO questions (quiz_id, question_text, quiz_name) VALUES (?, ?, ?)");
        $stmt->execute([$quizId, $questionText, $quizName]);
...
<div class="container mt-5">
    ...
    <input type="text" class="form-control mb-2" name="quiz_name" required>
</div>
